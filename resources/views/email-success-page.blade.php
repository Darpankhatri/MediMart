...
<head>
    ...
    <body class="loading authentication-bg">
                        ...
                        <div class="card shadow-none">
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="mt-3 text-center">
                                    ...
                                    <h3>Success !</h3>
                                    <p class="text-muted"> A email has been send to <b>{{ $email }}</b>.
                                        Please check for an email from company and click on the included link to
                                        Active your Account. </p>

                                    <a href="{{ route('web.index') }}" class="btn w-100 btn-primary waves-effect waves-light mt-3">Back to Home</a>
                                </div>
        ...
        <footer class="footer footer-alt">
            <script>document.write(new Date().getFullYear())</script> &copy; Graphical theme by <a href="{{ route('web.index') }}" class="link-dark text-decoration-underline">KumarBrothers</a> 
        </footer>
